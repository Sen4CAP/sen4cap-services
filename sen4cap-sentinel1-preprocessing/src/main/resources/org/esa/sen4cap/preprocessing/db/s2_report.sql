SELECT 	d.orbit_id as orbit,
	substr(split_part(d.product_name, '_', 3), 1, 8) as acquisition_date,
	...
	FROM downloader_history d
		...
		LEFT JOIN product p ON REPLACE(p.name, 'MSIL2A', 'MSIL1C') = d.product_name WHERE d.satellite_id = 1 and d.site_id = ?
